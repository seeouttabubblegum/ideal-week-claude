        ...
        Section(
            ...
            pages: [
                Page(id: "next.page",
                     imageName: "tour_next",
                     title: "The Next? page",
                     caption: "Nothing here touches the week you are in. Park anything you are not ready to commit to on this list, and use the button at the bottom to build the plan. Close to the weekend it opens straight away; earlier in the week it asks for your PIN, so planning early stays a deliberate choice."),
                Page(id: "next.pick",
